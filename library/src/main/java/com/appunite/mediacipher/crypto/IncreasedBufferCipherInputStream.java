...
/**
 * A IncreasedBufferCipherInputStream is copy of CipherInputStream with increases
 * ibuffer size so decryption is much faster.
 *
 * // Google doc
...
public class IncreasedBufferCipherInputStream extends FilterInputStream {
    ...
    /* the buffer holding data that have been read in from the
       ...
       engine. the size of 8192 bytes IS NOT randomly chosen as in original implementation */
     ...
     */
    public IncreasedBufferCipherInputStream(InputStream is, Cipher c) {
        super(is);
        input = is;
        cipher = c;
    }
     ...
     * @param is the to-be-processed input stream
     */
    protected IncreasedBufferCipherInputStream(InputStream is) {
        super(is);
        input = is;
    ...
    public void setIbuffer(final byte[] ibuffer) {
